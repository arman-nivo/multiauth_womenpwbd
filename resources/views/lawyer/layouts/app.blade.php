  ...
  <div class="container-scroller">
            ...
            <div class="input-group">
              <div class="input-group-prepend hover-cursor" id="navbar-search-icon">
                <span class="input-group-text" id="search">
                  <h1 style="font-weight: bold;font-size: 29px;"><span style="color: red;">Lawyer</span> Dashboard</h1>
                </span>
              </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <form method="POST" action="{{ route('lawyer.logout') }}">
                    @csrf
                    <a class="dropdown-item" href="route('lawyer.logout')"onclick="event.preventDefault();
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="http://127.0.0.1:8000/lawyer/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('add_law_time')}}" >
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">check Lawyer</span>

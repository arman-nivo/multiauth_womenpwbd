...
<body>
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-end">
            ...
            <div class="input-group">
              <div class="input-group-prepend hover-cursor" id="navbar-search-icon">
                <span class="input-group-text" id="search">
                  <h1 style="font-weight: bold;font-size: 29px;"><span style="color: red;">Admin</span> Dashboard</h1>
                </span>
              </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="route('profile.edit')" data-toggle="dropdown" id="profileDropdown">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="http://127.0.0.1:8000/admin/teacher">
              <i class="icon-grid menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="http://127.0.0.1:8000/admin/lawyer">
              <i class="icon-grid menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="http://127.0.0.1:8000/admin/courses">
              <i class="icon-grid menu-icon"></i>
          ...
          <li class="nav-item">
            <a class="nav-link"  href="http://127.0.0.1:8000/admin/lawservice">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Law service</span>
            </a>
          </li>
        </ul>
      </nav>
  ...
  <script src="{{asset('backend_asset/js/dataTables.select.min.js')}}"></script>

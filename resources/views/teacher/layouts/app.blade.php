  ...
  <div class="container-scroller">
            ...
            <div class="input-group">
              <div class="input-group-prepend hover-cursor" id="navbar-search-icon">
                <span class="input-group-text" id="search">
                  <h1 style="font-weight: bold;font-size: 29px;"><span style="color: red;">Teacher</span> Dashboard</h1>
                </span>
              </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="http://127.0.0.1:8000/teacher/dashboard">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{route('add_class_edit')}}" >
              <i class="icon-layout menu-icon"></i>
              <span class="menu-title">Add Class Time</span>

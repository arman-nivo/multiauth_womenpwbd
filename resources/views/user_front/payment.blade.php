                  ...
                  <td>
                    ...
                    <table width="220" border="0" cellpadding="0" cellspacing="0" align="right" class="col">
                      <tbody>
                        ...
                        <tr>
                          <td style="font-size: 21px;  color: #f07b26; letter-spacing: -1px; font-family: 'Open Sans', sans-serif; line-height: 1; vertical-align: top; text-align: right;">
                            Invoice
                          </td>
                        </tr>
                        <tr>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;" align="right">{{$payfor_law ->service_price}}</td>
                    </tr>
                    <tr>
                ...
                <table width="480" border="0" cellpadding="0" cellspacing="0" align="center" class="fullPadding">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                        <strong>{{$payfor_law ->service_price + 700}}</strong>
                      </td>
                    </tr>
  ...
  <tr>
    <td>
      <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable" bgcolor="#ffffff" style="border-radius: 0 0 10px 10px;">
        ...
        <tr class="spacer">
          <td height="50" style="text-align: center;padding: 31px 10pc;">
          <a type="button" href="{{route('success-law',['law_n_id' => $payfor_law->id])}}" style="
    padding: 16px;background-color: #f07b26;
    border-radius: 8px;text-decoration: none;color: white;
    font-weight: bold;"> Make payment</a>
          </td>
        </tr>

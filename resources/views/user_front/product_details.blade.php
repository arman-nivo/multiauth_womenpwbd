      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="left-image">
            <img src="{{$all_course->img}}" alt="">
          </div>
        </div>
        <div class="col-lg-6 align-self-center">
          <h4>{{$all_course->name}}</h4>
          <span class="price"><em>1200000</em>{{$all_course->service_price}}</span>
          <p>	{{$all_course->service_details}}</p>
          
          <form id="qty" action="#">
            <button type="submit"  style="background-color: #f07b26;"><i class="fa fa-shopping-bag"></i> <a href="{{ route('add-to-course', ['cor_id' => $all_course->id]) }}"
            style="background-color: #f07b26;border: none;" class="btn btn-primary">Add to Cart</a></button>
          </form>
           
          <ul>
            <li><span>Course Start</span> {{$all_course->course_start}}</li>
            <li><span>Course Start</span> {{$all_course->course_end}}</li>
            <li><span>Multi-tags:</span> {{$all_course->service_provider}}</li>
          </ul>
        </div>
        <div class="col-lg-12">
          <div class="sep"></div>

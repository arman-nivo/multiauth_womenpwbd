          ...
          <li class="nav-item nav-search d-none d-lg-block">
            <div class="input-group">
              <div class="input-group-prepend hover-cursor" id="navbar-search-icon">
                ...
                <h1 style="font-weight: bold;font-size: 29px;"><span style="color: red;">Buyer</span> Dashboard</h1>
                </span>
              </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="{{ route('user_law_services')}}">
              <i class="icon-grid menu-icon"></i>
              <span class="menu-title">Law services</span>
            </a>
          </li>

          <li class="nav-item">
            <a class="nav-link"  href="{{ route('course_Of_User') }}">
              <i class="icon-grid menu-icon"></i>
